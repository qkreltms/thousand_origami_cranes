...
//        return  new ListViewItem(id, memo, date, type, null);
//    }
//
...
//        if (c.moveToFirst()) {
//            do {
//                list.add(new ListViewItem(Integer.valueOf(c.getString(idIndex)), c.getString(textIndex), c.getString(dateIndex), null));
//            } while (c.moveToNext());
//        }
//        c.close();
//
